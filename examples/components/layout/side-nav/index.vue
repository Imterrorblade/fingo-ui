  ...
  <div
    ...
    <ul>
      ...
      <li
        ...
        :key="key">
        <a v-if="!item.path && !item.href" @click="expandMenu">{{item.label || name}}</a>
        ...
        <ul class="pure-menu-list sub-nav" v-if="item.list">
          <li
            ...
            <router-link
              ...
              exact
              v-text="navItem.label || navItem.name">
            </router-link>
          </li>
        </ul>
        <template v-if="item.groups">
          <div
            ...
            :key="key"
            >
            <div class="nav-group__title" @click="expandMenu">{{group.label || group.name}}</div>
            <ul class="pure-menu-list">
              <li
                ...
                <router-link
                  ...
                  :to="base + navItem.path"
                  exact
                  v-text="navItem.label || navItem.name"></router-link>
              </li>
            </ul>
          </div>
        </template>
...
<script>
import { menus } from 'examples/routes';
// import bus from '../bus';
